...
func CreateCodeSandboxDocker(ctx context.Context) *client.Client {
...
func AddFileToDockerSandbox(ctx context.Context, cli *client.Client, fileName string, content string) {
